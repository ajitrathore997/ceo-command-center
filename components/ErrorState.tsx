...
export function ErrorState({
  ...
  return (
    <section
      className={`border border-red-200 bg-red-50 text-red-950 dark:border-red-900 dark:bg-red-950/30 dark:text-red-100 ${compact ? "rounded-md p-3" : "w-full max-w-sm rounded-xl p-6 text-center shadow-sm"}`}
      role="alert"
    >
